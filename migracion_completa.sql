-- =============================================================
-- CASA LA37 — Migración completa (versión segura, sin duplicados)
-- =============================================================
...
-- ── 3. Retención Octus 3.5% ───────────────────────────────────
UPDATE locales SET retencion_pct = 3.5
  WHERE numero IN ('201','202','203','204')
     OR (numero ILIKE '%201%' AND nombre ILIKE '%Octus%')
     OR (numero ILIKE '%202%' AND nombre ILIKE '%Octus%')
     OR (numero ILIKE '%203%' AND nombre ILIKE '%Octus%')
     OR (numero ILIKE '%204%' AND nombre ILIKE '%Octus%');

-- ── 4. Porcentajes de distribución ───────────────────────────
UPDATE propietarios SET porcentaje_real = 22.22 WHERE nombre ILIKE '%Stella%';
UPDATE propietarios SET porcentaje_real = 22.22 WHERE nombre ILIKE '%Ximena%';
...
-- ── 5. Arriendos actuales (Junio 2026) ────────────────────────
...
-- ── 6. Periodos históricos (INSERT seguro, sin duplicar) ──────
DO $$
DECLARE
...
BEGIN
  ...
  -- ── Insertar periodos si no existen, luego obtener su ID ────
  ...
  ON CONFLICT (mes,anio) DO UPDATE SET estado='cerrado', tasa_seguridad=0;
  ...
  (l301,pid_ene,1956992,0,0,12714,20923,0,33637,1990629,'pagado','pagado','2026-02-02','2026-02-02'),
  (l302,pid_ene,1956993,0,0,12714,20923,0,33637,1990630,'pagado','pagado','2026-01-30','2026-01-30'),
  (l303,pid_ene,1960000,0,0,12714,20923,0,33637,1993637,'pagado','pagado','2026-01-22','2026-01-22'),
  (l304,pid_ene,1757252,0,0,12714,20923,0,33637,1790889,'pagado','pagado','2026-01-09','2026-01-09'),
  (l305,pid_ene,3690800,0,0,12714,20923,0,33637,3724437,'pagado','pagado','2026-01-30','2026-01-30'),
  (l306,pid_ene,2187900,0,0,12714,20923,0,33637,2221537,'pagado','pagado','2026-01-01','2026-01-01'),
  (l401,pid_ene,5509300,0,0,12714,20923,0,33637,5542937,'pagado','pagado','2026-01-30','2026-01-30')
  ON CONFLICT (local_id,periodo_id) DO NOTHING;

  DELETE FROM gastos WHERE periodo_id = pid_ene;
  ...
  (l301,pid_feb,1956993,0,0,12714,20923,0,33637,1990630,'pagado','pagado','2026-02-25','2026-02-25'),
  (l302,pid_feb,2350000,0,0,12714,20923,0,33637,2383637,'pagado','pagado','2026-02-05','2026-02-05'),
  (l303,pid_feb,1960000,0,0,12714,20923,0,33637,1993637,'pagado','pagado','2026-02-16','2026-02-16'),
  (l304,pid_feb,1757252,0,0,12714,20923,0,33637,1790889,'pagado','pagado','2026-02-13','2026-02-13'),
  (l305,pid_feb,3690800,0,0,12714,20923,0,33637,3724437,'pagado','pagado','2026-02-28','2026-02-28'),
  (l306,pid_feb,2187900,0,0,12714,20923,0,33637,2221537,'pagado','pagado','2026-02-01','2026-02-01'),
  (l401,pid_feb,5509300,0,0,12714,20923,0,33637,5542937,'pagado','pagado','2026-02-28','2026-02-28')
  ON CONFLICT (local_id,periodo_id) DO NOTHING;

  DELETE FROM gastos WHERE periodo_id = pid_feb;
  INSERT INTO gastos (periodo_id,descripcion,monto,categoria) VALUES
  ...
  (pid_feb,'Materiales (boquilla, silicona, cemento, granito, pintura)',336152,'mantenimiento'),
  (pid_feb,'Trabajadores (varios días)',880000,'mantenimiento'),
  ...
  (pid_feb,'Pintura tráfico disolvente cinta',108452,'mantenimiento'),
  (pid_feb,'Grapa silicona válvula PVC',39900,'mantenimiento');
  ...
  (l301,pid_mar,1956993,0,0,12714,20923,0,33637,1990630,'pagado','pagado','2026-03-27','2026-03-27'),
  (l302,pid_mar,2350000,0,0,12714,20923,0,33637,2383637,'pagado','pagado','2026-03-16','2026-03-16'),
  (l303,pid_mar,1960000,0,0,12714,20923,0,33637,1993637,'pagado','pagado','2026-03-16','2026-03-16'),
  (l304,pid_mar,1757252,0,0,12714,20923,0,33637,1790889,'pagado','pagado','2026-03-12','2026-03-12'),
  (l305,pid_mar,3690800,0,0,12714,20923,0,33637,3724437,'pagado','pagado','2026-03-30','2026-03-30'),
  (l306,pid_mar,2453000,0,0,12714,20923,0,33637,2486637,'pagado','pagado','2026-03-05','2026-03-05'),
  (l401,pid_mar,5509300,0,0,12714,20923,0,33637,5542937,'pagado','pagado','2026-03-30','2026-03-30')
  ON CONFLICT (local_id,periodo_id) DO NOTHING;

  DELETE FROM gastos WHERE periodo_id = pid_mar;
  INSERT INTO gastos (periodo_id,descripcion,monto,categoria) VALUES
  ...
  (l301,pid_abr,1956993,0,0,12714,20923,0,33637,1990630,'pagado','pagado','2026-04-23','2026-04-23'),
  (l302,pid_abr,2350000,0,0,12714,20923,0,33637,2383637,'pagado','pagado','2026-04-17','2026-04-17'),
  (l303,pid_abr,1960000,0,0,12714,20923,0,33637,1993637,'pagado','pagado','2026-04-16','2026-04-16'),
  (l304,pid_abr,2350000,0,0,12714,20923,0,33637,2383637,'pagado','pagado','2026-04-08','2026-04-08'),
  (l305,pid_abr,3690800,0,0,12714,20923,0,33637,3724437,'pagado','pagado','2026-04-30','2026-04-30'),
  (l306,pid_abr,2453000,0,0,12714,20923,0,33637,2486637,'pagado','pagado','2026-04-06','2026-04-06'),
  (l401,pid_abr,5509300,0,0,12714,20923,0,33637,5542937,'pagado','pagado','2026-04-30','2026-04-30')
  ON CONFLICT (local_id,periodo_id) DO NOTHING;

  DELETE FROM gastos WHERE periodo_id = pid_abr;
  INSERT INTO gastos (periodo_id,descripcion,monto,categoria) VALUES
  ...
  (l301,pid_may,1956993,0,0,12714,20923,0,33637,1990630,'pagado','pagado','2026-05-22','2026-05-22'),
  (l302,pid_may,2350000,0,0,12714,20923,0,33637,2383637,'pagado','pagado','2026-05-19','2026-05-19'),
  (l303,pid_may,1960000,0,0,12714,20923,0,33637,1993637,'pagado','pagado','2026-05-16','2026-05-16'),
  (l304,pid_may,2350000,0,0,12714,20923,0,33637,2383637,'pagado','pagado','2026-05-08','2026-05-08'),
  (l305,pid_may,3890800,0,0,12714,20923,0,33637,3924437,'pagado','pagado','2026-05-28','2026-05-28'),
  (l306,pid_may,2453000,0,0,12714,20923,0,33637,2486637,'pagado','pagado','2026-05-06','2026-05-06'),
  (l401,pid_may,5509300,0,0,12714,20923,0,33637,5542937,'pagado','pagado','2026-05-28','2026-05-28')
  ON CONFLICT (local_id,periodo_id) DO NOTHING;

  DELETE FROM gastos WHERE periodo_id = pid_may;
  INSERT INTO gastos (periodo_id,descripcion,monto,categoria) VALUES
  ...
  (l205,pid_jun,9200000,0,0,12714,20923,0,33637,9233637,'pagado','pagado','2026-06-06','2026-06-06'),
  (l301,pid_jun,1956993,0,0,12714,20923,0,33637,1990630,'pagado','pagado','2026-05-22','2026-05-22'),
  (l302,pid_jun,2350000,0,0,12714,20923,0,33637,2383637,'pagado','pagado','2026-05-19','2026-05-19'),
  (l303,pid_jun,1960000,0,0,12714,20923,0,33637,1993637,'pagado','pagado','2026-05-16','2026-05-16'),
  (l304,pid_jun,2350000,0,0,12714,20923,0,33637,2383637,'pagado','pagado','2026-05-08','2026-05-08'),
  (l305,pid_jun,3890800,0,0,12714,20923,0,33637,3924437,'pagado','pagado','2026-05-28','2026-05-28'),
  (l306,pid_jun,2453000,0,0,12714,20923,0,33637,2486637,'pagado','pagado','2026-05-06','2026-05-06'),
  (l401,pid_jun,5509300,0,0,12714,20923,0,33637,5542937,'pagado','pagado','2026-05-28','2026-05-28')
  ON CONFLICT (local_id,periodo_id) DO NOTHING;

  DELETE FROM gastos WHERE periodo_id = pid_jun;
  INSERT INTO gastos (periodo_id,descripcion,monto,categoria) VALUES
...
-- Verifica resultado:
SELECT mes, anio, estado FROM periodos ORDER BY anio, mes;
