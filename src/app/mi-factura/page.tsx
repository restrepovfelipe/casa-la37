            ...
            <Card key={f.id} className="overflow-hidden">
              <CardContent className="p-0">
                ...
                <div className="px-5 py-4">
                  ...
                  <div className="border-t pt-3 space-y-2" style={{ borderColor: 'oklch(0.880 0.012 72)' }}>
                    <div className="flex items-center justify-between">
                      ...
                      {f.estado_servicios === 'pagado'
                        ? <Badge style={{ backgroundColor: '#16a34a' }} className="text-xs">Pagado {f.fecha_pago_servicios ? new Date(f.fecha_pago_servicios).toLocaleDateString('es-CO') : ''}</Badge>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {f.estado_arriendo === 'pagado'
                        ? <Badge style={{ backgroundColor: '#16a34a' }} className="text-xs">Pagado {f.fecha_pago_arriendo ? new Date(f.fecha_pago_arriendo).toLocaleDateString('es-CO') : ''}</Badge>
                        : <Badge variant="outline" className="text-xs" style={{ color: '#b45309', borderColor: '#d97706' }}>Pendiente</Badge>
                      }
                    </div>
